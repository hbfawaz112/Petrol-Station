              ...
              if (val.docs.length > 0)
                {
                  ...
                  print('${container_category} isssssssssssssssssssssssssssssssssssssssssssssssssss')
                }
              else
                {print("Not Foundooooooooooooooooooo")}
            });
  }
      ...
      await FirebaseFirestore.instance
          ...
          .then((val) => {
                if (val.docs.length > 0)
                  ...
                  {print("Not Foundaaaaaaaaaaaaaaaaaaaaaaaaaaa")}
              });
