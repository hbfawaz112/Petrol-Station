...
class _ShipmentsState extends State<Shipments> {
  ...
  void asyncMethod() async {
    ...
    if (loggedInUser != null) {
      ...
      getFirstCategory();
      dateController.text = ff.format(DateTime.now()).toString();
      fromDateController.text = ff.format(DateTime.now()).toString();
      toDateController.text = ff.format(DateTime.now()).toString();
      //getVolume();
    }
    setState(() {});
                          ...
                          StreamBuilder(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                ...
                                var c =
                                    snapshot.data.docs[0].data()["Capacity"];
                                  ...
                                  if (volume != null &&
                                    ...
                                    db
                                      ...
                                      Fluttertoast.showToast(
                                          msg:
                                              "The new shipment has been added...",
                      ...
                      child: Column(children: [
                        ...
                        TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderSide:
                                    BorderSide(color: colorF, width: 2.0),
                                borderRadius:
                                    BorderRadius.all(Radius.circular(32.0)),
                              ),
                              labelText: ff.format(today),
                        ...
                        TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderSide:
                                    BorderSide(color: colorT, width: 2.0),
                                borderRadius:
                                    BorderRadius.all(Radius.circular(32.0)),
                              ),
                              labelText: ff.format(today),
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            ISPaid == false
                                                                ...
                                                                : Text(documentSnapshot[
                                                                        ...
                                                                        null
                                                                    ? formatter
                                                                        .format(DateTime.tryParse((documentSnapshot['Paid_Date'])
                                                                            .toDate()
                                                                            .toString()))
                                                                        .toString()
                                                                    : 'not paid'),
                                                                      ...
                                                                      TextButton(
                                                                        onPressed:
                                                                          ...
                                                                          db
                                                                              ...
                                                                              .delete()
                                                                              .then((value) {
                                                                            db.collection('Stations').doc(station).collection('Container').where('Container_Name', isEqualTo: Container_Name).get().then((val) =>
                                                                                {
                                                                                  if (val.docs.length > 0)
                                                                                    {
                                                                                      print("lengthhhhhhhhhhh"),
